...
//-bof-zen_tags-lat9 *** 1 of 1 ***
    ...
    $input_fields = $zen_tags->generateProductTagInputs($pInfo->products_id);
?>
          <tr>
            <td class="main" style="background-color: #ebebff;"><?php echo $input_fields['label']; ?></td>
            <td class="main" style="background-color: #ebebff;"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $input_fields['input']; ?></td>
          </tr>
<?php
//-bof-zen_tags-lat9 *** 1 of 1 ***
?>
