...
//-bof-zen_tags-lat9 *** 1 of 4 ***
    $zen_tags = new ZenTags();
//-eof-zen_tags-lat9 *** 1 of 4 ***
?>
...
<?php
//-bof-zen_tags-lat9 *** 2 of 4 ***
?>
                <td class="dataTableHeadingContent" align="center"><?php echo ZEN_TAG_HEADING_TAGS; ?></td>
<?php
//-eof-zen_tags-lat9 *** 2 of 4 ***
?>
...
<?php
//-bof-zen_tags-lat9 *** 3 of 4 ***
?>
                <td class="dataTableContent" align="center"><?php echo $zen_tags->getCategoryTagList($categories->fields['categories_id']); ?></td>
<?php
//-eof-zen_tags-lat9 *** 3 of 4 ***
?>
...
<?php
//-bof-zen_tags-lat9 *** 4 of 4 ***
?>
                <td class="dataTableContent" align="center"><?php echo $zen_tags->getProductTagList($products->fields['products_id']); ?></td>
<?php
//-eof-zen_tags-lat9 *** 4 of 4 ***
?>
